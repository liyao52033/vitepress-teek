...
description: '一个为 VitePress 提供永久链接功能的插件，能确保文档访问地址稳定不变。它支持国际化、多语言路径前缀、路由重写和导航栏高亮，安装配置简单，但需注意插件仅在项目启动时生效，新增或修改文档后需重启项目。该插件通过扩展路由功能，方便开发者管理和跳转文档，提升文档站点的用户体验和维护效率。'
tags:
  - 插件
author:
  name: 华总
